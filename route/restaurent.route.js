...
const DIR = '/home/rajkaria/Documents/Zomato2/controller/restaurent/uploads/image';
...
app.post('/res/getreviews',getreviewcoontrol.getreview);
app.get('/res/restaurents', getrestaurentcontrol.getrestaurents);
app.post('/res/restaurentdetail', getrestaurentdetailcontrol.getrestaurentdetails);
app.post('/res/search', searchrestaurentcontrol.searchbyrestaurent);
app.post('/res/addrating', addratingcontrol.addrating);
app.post('/res/viewrating', viewaverageratingcontrol.viewaveragerating);
